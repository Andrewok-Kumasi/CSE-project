 ...
 *
 */
public final class RSSAggregator3 {

    /**
     * Private constructor so this utility class cannot be instantiated.
     */
    private RSSAggregator3() {
    }
    ...
    private static void processFeed(String url, String file,
            SimpleWriter cout) {
        cout = new SimpleWriter1L(file);
        XMLTree xml = new XMLTree1(url);

        outputHeader(xml, cout);
        for (int a = 0; a < xml.numberOfChildren(); a++) {
            processItem(xml.child(a), cout);
        }

        outputFooter(cout);
        cout.print("Outputing to file successful");
    }
