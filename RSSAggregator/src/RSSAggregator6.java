 ...
 *
 */
public final class RSSAggregator6 {

    /**
     * Private constructor so this utility class cannot be instantiated.
     */
    private RSSAggregator6() {
    }
    ...
    private static void processItem(XMLTree item, SimpleWriter out) {
        ...
        if (index >= 0) {
            out.print("<td><a href=\"" + item.child(index).attributeValue("url")
        ...
        if (index >= 0) {
            if (link > 0) {
                out.print("<td><a href=\"" + item.child(link).label() + ">"
                        + item.child(index) + "</a></td></tr>");
            } else {
            ...
            if (index >= 0 && item.child(index).numberOfChildren() > 0) {
                if (item.child(link).numberOfChildren() > 0) {
                    ...
                    out.print(
                            "<td>" + item.child(index).label() + "</td></tr>");
                }
            }
        }
    }
